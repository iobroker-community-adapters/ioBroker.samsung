                                    ...
                                    while (1) {
                                        switch ((_context.prev = _context.next)) {
                                            ...
                                            case 7:
                                                ...
                                                channel = `${this.wsapi}channels/samsung.remote.control?name=${
                                                    appNameBase64
                                                ...
                                                return _context.abrupt(
                                                    ...
                                                    new _promise2.default(function (resolve, reject) {
                                                        ...
                                                        _this.ws.once('message', function (data, flags) {
                                                            ...
                                                            if (!data || data.event !== 'ms.channel.connect') {
            ...
            },
            {
                ...
                value: (function () {
                    var _ref2 = (0, _asyncToGenerator3.default)(
                        /*#__PURE__*/ _regenerator2.default.mark(function _callee2(key) {
                            return _regenerator2.default.wrap(
                                        ...
                                        switch ((_context2.prev = _context2.next)) {
                                            case 0:
                                                if (
                                                    !(
                                                        typeof key !== 'string' ||
                                                        _constants.KEY_CODES.indexOf(key) === -1
                                                    )
                                                ) {
                                                    _context2.next = 2;
                                                    break;
